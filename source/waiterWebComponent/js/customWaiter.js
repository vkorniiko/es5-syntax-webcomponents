...
CustomWaiter.prototype.initializeElements = function(element){
  ...
  element.waiterHolderElement = 
    element.shadowRoot.querySelector(".waiterHolder");
...
CustomWaiter.prototype.attributeChangedCallback = 
...
window.customElements.define("custom-waiter", CustomWaiter);
