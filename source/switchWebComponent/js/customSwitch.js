...
CustomSwitch.prototype.initialize = function(element){
  ...
  element.onSwitchClickEventHandler = 
    this.onSwitchClickEventHandler.bind(element);
...
CustomSwitch.prototype.attributeChangedCallback = 
...
CustomSwitch.prototype.subscribe = function(){
  ...
  this.switchElement.addEventListener(
    "click", this.onSwitchClickEventHandler);
};
...
CustomSwitch.prototype.unSubscribe = function(){
  ...
  this.switchElement.removeEventListener(
    "click", this.onSwitchClickEventHandler);
};
