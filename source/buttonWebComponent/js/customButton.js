...
CustomButton.prototype.initialize = function(element){
  ...
  element.onButtonClickEventHandler = 
    this.onButtonClickEventHandler.bind(element);
...
CustomButton.prototype.attributeChangedCallback = 
...
CustomButton.prototype.unSubscribe = function(){
  ...
  this.buttonElement.removeEventListener(
    "click", this.onButtonClickEventHandler);
};
