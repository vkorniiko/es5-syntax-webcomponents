...
CustomText.prototype.initialize = function(element){
	...
	element.onClearClickEventHandler = this.onClearClickEventHandler.bind(element);
	element.onValueChangeEventHandler = this.onValueChangeEventHandler.bind(element);
	element.onValueKeyUpEventHandler = this.onValueKeyUpEventHandler.bind(element);
...
CustomText.prototype.attributeChangedCallback = function(name, oldValue, newValue){
...
CustomText.prototype.subscribe = function(){
	...
	this.clearButtonElement.addEventListener('click', this.onClearClickEventHandler);
...
CustomText.prototype.unSubscribe = function(){
	...
	this.clearButtonElement.removeEventListener('click', this.onClearClickEventHandler);
...
CustomText = window.customElements.define("custom-text", CustomText);